...
{
    public partial class Discount_Material_Data : Form
    {
        public Discount_Material_Data()
        {
            InitializeComponent();
        }
        DataTable data2 = new DataTable("DiscountMaterial");
        DataTable data3 = new DataTable("DiscountMaterial_Bill");
        string Purchase_ID = "";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                data3 = new DataTable("DiscountMaterial_Bill");
                ...
                string display1 = string.Format("SELECT * FROM DiscountMaterial_Bill WHERE Purchase_ID ='" + Purchase_ID + "'");
                conne.Open();
        ...
        private void Discount_Material_Data_Load(object sender, EventArgs e)
        {
            ...
            string sslect = string.Format("SELECT * FROM DiscountMaterial");
            conn.Open();
        ...
        private void textBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)13)
            {
                ...
                data3.RowFilter = string.Format("PurchasesProduct_Employee_ID = '" + textBox1.Text + "'");
